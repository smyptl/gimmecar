        ...
        li
          router-link(:to="{ name: 'rentals' }")
            svg(xlmns='http://www.w3.org/2000/svg' viewBox='-35 -15 1050 1050' preserveAspectRatio='xMinYMin')
              path(d='M474.112 20q198 -2 340 136t146 336q2 200 -136 342t-338 146q-198 2 -341 -137t-145 -337q-4 -200 135 -342t339 -144zm12 858q156 -2 266 -114t108 -270 -115 -267 -269 -107q-158 2 -267 114t-107 270 114 267 270 107zm-234 -154q4 -26 12 -66t41 -128 77 -132 125 -76 141 -42l60 -10q-4 26 -12 66t-41 128 -77 132q-42 42 -124 74t-142 42zm180 -276q-22 20 -22 48t22 50q20 22 49 22t49 -22q52 -52 88 -186 -136 36 -186 88z')
            span Rentals
